...
import com.zmx.weblog.web.model.vo.archive.FindArchiveArticlePageListRspVO;
import com.zmx.weblog.web.model.vo.archive.FindArchiveArticleRspVO;
import com.zmx.weblog.web.service.ArchiveService;
...
public class ArchiveServiceImpl implements ArchiveService {
    ...
    public Response findArchivePageList(FindArchiveArticlePageListReqVO findArchiveArticlePageListReqVO) {
        ...
        // 分页查询
        IPage<ArticleDO> page = articleMapper.selectPageList( null, null, null,current, size);
